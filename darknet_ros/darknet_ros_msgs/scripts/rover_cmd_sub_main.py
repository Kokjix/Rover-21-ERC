...
global isTeleoprator, isAutonom
isTeleoprator = False
isAutonom = False
...
def main():
	...
	rospy.Subscriber("/cmd_vel1", Twist, callbacknav1)
	rospy.Subscriber("/cmd_vel2", Twist, callbacknav2)
	...
	while not rospy.is_shutdown():
		...
		if isTeleoprator == True and isAutonom == False:
			print("S"+ all_wheels_msg+ robotic_arm_msg + science_msg +"1"+"1"+"F")
			pub.publish("S"+ all_wheels_msg + robotic_arm_msg + science_msg +"1"+"1"+"F")
		if isTeleoprator == False and isAutonom == True:
			print("S"+ all_wheels_msg+ robotic_arm_msg + science_msg +"1"+"2"+"F")
			pub.publish("S"+ all_wheels_msg + robotic_arm_msg + science_msg +"1"+"2"+"F")
		if isTeleoprator == False and isAutonom == False:
			print("S"+ all_wheels_msg+ robotic_arm_msg + science_msg +"1"+"0"+"F")
			pub.publish("S"+ all_wheels_msg + robotic_arm_msg + science_msg +"1"+"0"+"F")
		rate.sleep()
